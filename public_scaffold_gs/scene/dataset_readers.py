...
from public_scaffold_gs.scene.colmap_loader import read_extrinsics_text, read_intrinsics_text, qvec2rotmat, \
    read_extrinsics_binary, read_intrinsics_binary, read_points3D_binary, read_points3D_text
from public_scaffold_gs.utils.graphics_utils import getWorld2View2, focal2fov, fov2focal
import numpy as np
import json
...
try:
    ...
    print("No laspy")
from public_scaffold_gs.utils.sh_utils import SH2RGB
from public_scaffold_gs.scene.gaussian_model import BasicPointCloud
import cv2
...
def readColmapCameras(cam_extrinsics, cam_intrinsics, images_folder):
    ...
    for idx, key in enumerate(cam_extrinsics):
        ...
        # print("OIOIOI:", images_folder, extr.name)
